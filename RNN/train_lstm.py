...
BEST_TRAIN_ACCURACY_MODEL = '/root/kaggle/restaurantAvis/cache/train_model.ckpt'
BEST_DEV_ACCURACY_MODEL = '/root/kaggle/restaurantAvis/cache/dev_model.ckpt'

# Load Data
MOTS_UTILES = '/root/kaggle/restaurantAvis/cache/mots_utiles.txt'
MOTS_NECESSAIRES = '/root/kaggle/restaurantAvis/cache/mots_necessaires.txt'
X_TRAIN_CSV = '/root/kaggle/restaurantAvis/cache/X_train.csv'
Y_TRAIN_CSV = '/root/kaggle/restaurantAvis/cache/y_train.csv'
X_DEV_CSV = '/root/kaggle/restaurantAvis/cache/X_dev.csv'
Y_DEV_CSV = '/root/kaggle/restaurantAvis/cache/y_dev.csv'
PRETRAINED_VOCAB_CSV = '/root/kaggle/restaurantAvis/cache/pretrained_vocab.csv'
TO_TRAIN_VOCAB_CSV = '/root/kaggle/restaurantAvis/cache/to_train_vocab.csv'

EMB_DIM = 300 # 50,100, ou 300
EMBS_CSV = '/root/kaggle/restaurantAvis/cache/pretrained_embs_' + str(EMB_DIM) + '.csv'
